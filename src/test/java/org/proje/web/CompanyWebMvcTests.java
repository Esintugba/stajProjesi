...
public class CompanyWebMvcTests {
    @Autowired
    ...
    public void testCompanies() throws Exception{
        ...
        MatcherAssert.assertThat(mav.getViewName(), Matchers.equalTo("companies"));
        MatcherAssert.assertThat(mav.getModel().containsKey("companies"),Matchers.is(true));
    }
}
